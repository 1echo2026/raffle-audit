...
(function () {
  ...
  var TPL_KEY = 'raffle_templates_v2';
  var DEFAULT_TEMPLATES = [
    {type: '重复抽奖', script: '{姓名}老师好，这边正在核对{期数}期{周期}的宠粉日抽奖，看到您用出单号码{手机号}抽了两次～咱们是一单只能参与一次的～所以只能算您抽奖时间早的那一次哦～辛苦老师下次注意啦'},
    {type: '提交时间超范围', script: '{姓名}老师好，我们正在核对{期数}期{周期}宠粉日的抽奖活动，看到您使用{手机号}这个号码参与抽奖啦，但后台核实到老师这单是在{出单时间}出的哦，不能参与咱们第{期数}期{周期}的抽奖哈~老师后续出单要及时在群里晒单参与当期的抽奖哦，周三晚上出单的也可以晒单在群里这边会帮老师您登记上的哦~'},
